...
| C1, C2, C3, C5 | Main-Agent | `examples/workflow_email/**`, `bindings/go/examples/workflow_chat_history/**`, `docs/EXAMPLES.md`, `Makefile` | Cross-language examples need practical parity and low-friction run flows | Node/Go/Python chat-history examples + docs include parity flags and consistent make-based run commands | completed | Added `run-python-chat-history` and documented shared YAML parity flows |
