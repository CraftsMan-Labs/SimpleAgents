...
| C1, C2, C3 | Main-Agent | `examples/workflow_email/**`, `bindings/go/examples/workflow_chat_history/**`, `docs/EXAMPLES.md` | Cross-language examples need practical parity and low-friction run flows | Node/Go chat-history examples + docs include parity flags and direct run commands | completed | Added direct Go run instructions aligned with existing Python chat-history flow |
